...
FCKConfig.ToolbarSets["Description"] = [
	['Source', '-', 'Cut','Copy','Paste','PasteText','PasteWord', '-', 'Undo','Redo'],
...
FCKConfig.ToolbarSets["you_mail"] = [
	['Bold','Italic','Underline', 'StrikeThrough', 'TextColor', 'BGColor', '-', 'JustifyLeft','JustifyCenter','JustifyRight','JustifyFull', '-', 'OrderedList','UnorderedList','-','Link','Unlink','Image']
] ;
...
FCKConfig.FontSizes		= '10px;12px;14px;16px;18px;20px' ;
...
FCKConfig.LinkBrowserWindowWidth	= FCKConfig.ScreenWidth * 0.8 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= FCKConfig.ScreenHeight * 0.8 ;	// 70%

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'ckfinder/ckfinder.html?type=Images';
FCKConfig.ImageBrowserWindowWidth  = 700 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = 400 ;	// 70% ;

FCKConfig.FlashBrowser = true ;
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'ckfinder/ckfinder.html?type=Flash';
FCKConfig.FlashBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.8 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight = FCKConfig.ScreenHeight * 0.8 ;	//70% ;

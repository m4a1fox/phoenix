	...
	if( count($files) > 2 ) { /* The 2 accounts for . and .. */
		...
		foreach( $files as $file ) {
			if( file_exists($root . $_POST['dir'] . $file) && $file != '.' && $file != '..' && !is_dir($root . $_POST['dir'] . $file) ) {
				...
				echo "<li class=\"file ext_$ext\"><div><a style='float: left;' href=\"#\" rel=\"" . htmlentities($_POST['dir'] . $file) . "\">" . htmlentities($file) . "</a><img class='delete-img' align='center' src='./public/img/delete.png'></div></li>";
			}
		}
		echo "</ul>";	
	}
